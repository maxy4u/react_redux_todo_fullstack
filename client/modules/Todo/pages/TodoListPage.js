...
// Import Actions
import { addTodoRequest, fetchTodos, completeTodoRequest, clearCompletedTodoRequest, editTodoRequest } from '../TodoActions';
...
class TodoListPage extends Component {
  ...
  handleEditTodo = (todo) =>{
    debugger;
    this.props.dispatch(editTodoRequest(todo ))
    ...
    return (
      <div>
        ...
        <TodoList
          ...
          todos={this.props.todos} handleEditTodo={this.handleEditTodo}
        />
      </div>
    );
  }
